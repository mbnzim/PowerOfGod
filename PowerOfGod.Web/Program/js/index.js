  ...
  let schedule = [
    {
      date: now,
      agenda: [
        {range: ['00:30', '08:59'], display: {h:8, m:24, a: 'am'}, location: 'Underscore Coffee Kitchen', desc: 'Breakfast Club Donuts + Coffee'},
        {range: ['09:00', '09:29'], display: {h:9, m:'', a: 'am'}, location: 'Solaris Terminal', desc: 'Registration + Team Check-in'},
        {range: ['09:30', '09:59'], display: {h:9, m:30, a: 'am'}, location: 'Underscore Coffee Bar', desc: 'Opening Prayer '},
        {range: ['10:00', '11:59'], display: {h:10, m:'', a: 'am'}, location: '', desc: 'Devotion'},
        {range: ['12:00', '12:29'], display: {h:'Noon', m:'', a: '-ish'}, location: 'Atomic Lunch Pad', desc: 'LUNCH: Taco Tuesday!'},
        {range: ['12:30', '17:59'], display: {h:12, m:30, a: 'pm'}, location: '', desc: 'Bible Study'},
        {range: ['18:00', '21:15'], display: {h:6, m:'', a: 'pm'}, location: 'Church Hall & Grill <br /><small>@ Second and Main</small>', desc: 'Welcome Reception + Dinner!'}
      ]
    // },
    // {
